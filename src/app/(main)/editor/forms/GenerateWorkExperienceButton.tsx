...
function InputDialog({
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent>
        <DialogHeader>
          <DialogTitle>職歴を生成</DialogTitle>
          <DialogDescription>
            この職歴について説明してください。AIが最適化されたエントリーを生成します。
          </DialogDescription>
        </DialogHeader>
        <Form {...form}>
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Textarea
                      {...field}
                      placeholder={`例: "2019年11月から2020年12月まで、Googleでソフトウェアエンジニアとして働きました。主な業務は..."`}
                      autoFocus
                    />
                  </FormControl>
                  <FormMessage />
